...
$trans_up_id = (int) $_GET['trans_up_id'];
$sql = "select * from transportation where id = '$trans_up_id'";
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Transport</h3>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="./transport_edit_act.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="trans_up_id" value="<?php echo $up_row['id'] ?>">    
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select name="transport_category_id" id="transport_category_id" class="form-control">
                                        ...
                                        <?php if($up_row['transport_category_id']==$row['id']) { echo "selected"; } ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="tag_line" id="" cols="30" class="form-control"><?php echo $up_row['title']; ?></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <img src="../uploads/transport_images/<?php echo $up_row['image']; ?>" width="50" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
